...
<div class="content-body-white">
    <form method="post" action="{{url('update-app-dev')}}" enctype="multipart/form-data">
          {{csrf_field()}}
        <div class="page-head">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 m-b-10px text-right">
                    ...
                    <button type="submit" class="btn btn-success" name="submit_button" value="save_next">Save & Add Obb File</button>
                    <button type="submit" class="btn btn-primary" name="submit_button" value="save">Save</button>
                </div>
            </div>
        </div>
    </form>
